...
# Example: /usr/lib/enigma2/python/Plugins/Extensions/CutsClear
# Example: /usr/lib/enigma2/python/Plugins/SystemPlugins/CutsClear
...
DEB_DREAMBOX_PY2=''
DEB_DREAMBOX_PY3=''
DEB_DREAMOS_DEFAULT='enigma2-plugin-extensions-cutsclear_1.3_all.deb'
...
IPK_OPENSOURCE_PY2=''
IPK_OPENSOURCE_PY3=''
IPK_OPENSOURCE_DEFAULT='enigma2-plugin-extensions-cutsclear_1.3_all.ipk'
